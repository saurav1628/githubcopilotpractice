...
activities = {
    ...
    "Soccer Club": {
        "description": "Recreational and competitive soccer practice",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["nathan@mergington.edu", "maria@mergington.edu"]
    },
    "Art Club": {
        "description": "Explore various visual arts techniques and projects",
